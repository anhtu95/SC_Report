...
Mạng tích chập là một mạng neuron nhân tạo nhiều tầng. Nhưng điều khác biệt chính là ở mỗi neuron trong tầng ẩn của CNN sẽ không kết nối với toàn bộ các neuron thuộc tầng liền trước như mạng thông thường.
\begin{figure}[H]
...
\chapter{Thử nghiệm}
Cài đặt thử nghiệm trên thư viện keras kết quả 10 epoch: 
\begin{figure}[H]
\centering 
\includegraphics[scale=0.45]{sol2.png}
\caption{Kết quả}
\label{thunghiem}
\end{figure}
...
\bibitem{inceptionsource} Inception v4 in keras https://github.com/transcranial/inception-v4/blob/master/inception-v4.ipynb
\bibitem{wiki} Mạng neuron nhân tạo, Wikimedia
\end{thebibliography}
