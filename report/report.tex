...
Trong phần này, phần đầu chúng em sẽ giới thiệu khái quát về mạng CNN (\ref{sec_intro_cnn}) và sau đó sẽ đi chi tiết về các tầng trong kiến trúc mạng CNN (\ref{}).
